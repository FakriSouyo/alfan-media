...
// `Surface` is the mandated name of the surface primitive (a plain elevated
// `<div>`). It is the same implementation as `Elevated`, which additionally
// accepts shadow override + offset affordances. Both satisfy the primitive
// contract: read substrate → derive relative level → apply bg+shadow → publish
// the new substrate to descendants.
const Surface = Elevated;
Surface.displayName = "Surface";

export { Elevated, Surface };
